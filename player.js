// player.js - FIXED to remove player name from URL and properly load all weeks
class PlayerDetailPage {
    ...
    async init() {
        ...
        // Get ONLY player ID from URL parameters
        ...
        // Initialize IndexedDB through statsAPI first
        await this.initializeStatsAPI();
        
        // Load scoring rules for fantasy calculations
        await this.loadScoringRules();
        
        // Load player data (this will check all 18 weeks and fetch missing ones)
        await this.loadPlayerData();
    }

    // Rest of the methods remain the same, but updated to not use playerName in URL
    async loadPlayerData() {
        ...
        try {
            ...
            // Use the updated getPlayerCompleteStats method (only pass playerId)
